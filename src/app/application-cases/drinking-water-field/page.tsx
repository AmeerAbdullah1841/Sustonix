...
export default function DrinkingWaterFieldPage() {
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-sm text-white/80 mb-6">
          ...
          <span className="mx-2">›</span>
          <span className="text-white">High-quality drinking water field</span>
        </div>
        ...
        <div className="bg-black rounded-2xl shadow-xl p-6 mb-8">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
            ...
            <Link href="/application-cases/drinking-water-field" className="px-4 py-2 text-sm text-black bg-white rounded-lg font-semibold">
        ...
        {/* High-quality Drinking Water Field Content */}
        <section className="bg-gray-800 rounded-2xl shadow-xl p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
              <div className="w-4 h-4 bg-black rounded-full"></div>
            </div>
            <h2 className="text-2xl font-bold text-white">High-quality drinking water field</h2>
          </div>
          
          <div className="space-y-3 mb-8">
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">Rural drinking water treatment in Anhui</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">Urban water purification plant in Chongqing</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">Mountain area drinking water system in Sichuan</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">Hotel water treatment system in Hainan</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">School drinking water treatment in Jiangsu</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></div>
              <p className="text-white">Residential water purification in Zhejiang</p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="relative w-full h-64 bg-gray-100 rounded-lg overflow-hidden">
                <Image
src="https://omo-oss-image.thefastimg.com/portal-saas/new2024041015584165399/cms/image/37317f42-450c-47cc-a376-75c522abfa7f.webp_640xaf.webp"                  alt="Drinking Water Project 1"
                  fill
                  unoptimized
              ...
              <div className="relative w-full h-64 bg-gray-100 rounded-lg overflow-hidden">
                <Image
src="https://omo-oss-image.thefastimg.com/portal-saas/new2024041015584165399/cms/image/3ea52c50-bbb1-483d-a647-aa6528797be8.webp_640xaf.webp"                  alt="Drinking Water Project 2"
                  fill
                  unoptimized
                  className="object-cover"
                />
              ...
              <div className="relative w-full h-64 bg-gray-100 rounded-lg overflow-hidden">
                <Image
src="https://omo-oss-image.thefastimg.com/portal-saas/new2024041015584165399/cms/image/3e64c5aa-8e07-423f-87b9-4d5d9b359594.webp_640xaf.webp"                  alt="Drinking Water Project 3"
                  fill
                  unoptimized
                  className="object-cover"
                />
